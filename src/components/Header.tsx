      ...
      <div className="bg-editorial-charcoal text-neutral-200 text-xs py-2.5 px-4 flex flex-col md:flex-row justify-between items-center gap-2 border-b border-white/5 font-sans z-50 relative">
        <div className="flex items-center gap-4 flex-wrap justify-center">
          <span className="flex items-center gap-1.5 opacity-90">
            ...
            Guachipelín de Escazú, San Rafael, Costa Rica
          </span>
          <span className="flex items-center gap-1.5 opacity-90">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 md:px-6 flex justify-between items-center">
          ...
          <div className="hidden sm:flex items-center gap-3">
            <a
              href="#cotizador"
              className="border border-editorial-charcoal text-editorial-charcoal hover:bg-editorial-charcoal hover:text-white text-[10px] uppercase tracking-widest font-bold px-6 py-2.5 transition-colors duration-200 flex items-center gap-1.5"
            >
              ...
              <div className="px-4 py-4 space-y-2">
                ...
                <div className="pt-4 border-t border-editorial-camel/15 flex flex-col gap-3">
                  <a
                    href="#cotizador"
                    onClick={() => setIsOpen(false)}
                    className="w-full text-center border border-editorial-charcoal text-editorial-charcoal hover:bg-editorial-charcoal hover:text-white text-[10px] uppercase tracking-widest font-bold py-3 transition-colors block"
                  >
                    Agendar Cita
                  </a>
                </div>
